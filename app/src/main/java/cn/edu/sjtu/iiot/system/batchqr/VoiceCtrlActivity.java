...
public class VoiceCtrlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VoiceProcess=(Button)findViewById(R.id.VoiceProcess);
        et_content = (EditText) findViewById(R.id.et);
        et_content.setKeyListener(null);

        SpeechUtility.createUtility(this, SpeechConstant.APPID + "=59c1dfaa");
        ...
        VoiceProcess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(count==0) {
                    //System.out.println(mGrammarId);
                    //设置grammarId
                    //mIat.setParameter(SpeechConstant.CLOUD_GRAMMAR, mGrammarId);
                    count=1;
    ...
    private void parseResult(RecognizerResult results) {
        ...
        System.out.println(text + ": " + row_num + "_" + col_num + "_"+col_num_pointer +"_"+row_num_pointer);
    ...
    //读取语音识别语法
    private String readBnfFile()
    {
        int len = 0;
        byte []buf = null;
        String grammar = "";
        try {
            InputStream in = getAssets().open("test2.bnf");
            len  = in.available();
            buf = new byte[len];
            in.read(buf, 0, len);
